...
class UNet2d(nn.Module):
    def __init__(self, in_channels=10, out_channels=1, features=[32, 64, 128]):
        super().__init__()
        ...
        for feature in features:
            self.encoder_layers.append(DoubleConv(channels, feature))
            channels = feature
...
class UNet(nn.Module):
    def __init__(self, features):
        ...
        self.unet = UNet2d(in_channels=7, out_channels=1, features=features)
...
if __name__ == "__main__":
    ...
    param_combinations = [{"features": f} for f in param_grid["features"]]
